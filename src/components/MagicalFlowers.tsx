...
import './MagicalFlowers.scss';

const MagicalFlowers = () => {
    ...
    return (
        <div className={`magical-flowers-container ${!loaded ? 'not-loaded' : ''}`}>
            ...
            <div className="flowers">
                ...
                <div className="long-g long-g--0">
                    ...
                    <div className="grow-ans" style={{ '--d': '2.2s' } as any}>
                ...
                <div className="long-g long-g--2">
                    ...
                    <div className="grow-ans" style={{ '--d': '4.4s' } as any}>
                        <div className="leaf leaf--2"></div>
                    </div>
                    <div className="grow-ans" style={{ '--d': '4.6s' } as any}>
                        <div className="leaf leaf--3"></div>
                    </div>
                </div>
                ...
                <div className="long-g long-g--6">
                    ...
                    <div className="grow-ans" style={{ '--d': '4.8s' } as any}>
                        <div className="leaf leaf--3"></div>
                    </div>
                </div>
                ...
                <div className="long-g long-g--7">
                    ...
                    <div className="grow-ans" style={{ '--d': '3.5s' } as any}>
                        <div className="leaf leaf--2"></div>
                    </div>
                    <div className="grow-ans" style={{ '--d': '3.6s' } as any}>
                        <div className="leaf leaf--3"></div>
